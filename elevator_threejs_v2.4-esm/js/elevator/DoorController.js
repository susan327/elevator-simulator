...
export class DoorController {
  constructor(car,building){
    this.car=car;this.building=building;this.progress=0;this.target=0;this.duration=3.6;this.activeFloor=1;
  ...
  apply(){this.car.setDoorOpen(this.progress);this.building.setHallDoorOpen(this.activeFloor,this.progress);}
  animateTo(target){
  ...
  open(floor){
    ...
    if(this.activeFloor!==nextFloor)this.building.setHallDoorOpen(this.activeFloor,0);
    this.activeFloor=nextFloor;this.animateTo(1);
  }
  close(){this.animateTo(0);}
  forceClosed(){this.building.setHallDoorOpen(this.activeFloor,0);this.progress=0;this.target=0;this.elapsed=0;this.motionDuration=0;this.apply();}
