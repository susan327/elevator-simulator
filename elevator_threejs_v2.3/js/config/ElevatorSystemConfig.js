class ElevatorSystemConfig {
  constructor(){
    this.cabinPresets={
      small:{label:'小型 9人',capacity:9,load:600,carWidth:1.40,carDepth:1.35,carHeight:2.30,doorWidth:.80,doorHeight:2.00,windowWidth:.20,windowHeight:.72,windowTopMargin:.16},
      medium:{label:'中型 15人',capacity:15,load:1000,carWidth:1.60,carDepth:1.50,carHeight:2.30,doorWidth:.90,doorHeight:2.10,windowWidth:.32,windowHeight:1.00,windowTopMargin:.20},
      large:{label:'大型 20人',capacity:20,load:1350,carWidth:1.80,carDepth:1.70,carHeight:2.40,doorWidth:1.10,doorHeight:2.10,windowWidth:.28,windowHeight:.90,windowTopMargin:.15}
    };
    this.motionPresets={
      low:{label:'低速',maxSpeed:1.00,acceleration:.55,deceleration:.55,accelJerk:.45,decelJerk:.38,landingSpeed:.040,landingDistance:.30},
      medium:{label:'中速',maxSpeed:1.75,acceleration:.70,deceleration:.70,accelJerk:.55,decelJerk:.45,landingSpeed:.035,landingDistance:.34},
      high:{label:'高速',maxSpeed:3.00,acceleration:.85,deceleration:.85,accelJerk:.65,decelJerk:.50,landingSpeed:.030,landingDistance:.40},
      ultra:{label:'超高速',maxSpeed:5.00,acceleration:1.00,deceleration:1.00,accelJerk:.75,decelJerk:.55,landingSpeed:.025,landingDistance:.48}
    };
  ...
  set(key,value){
    const rules={
      floors:[2,60,1],floorHeight:[2.8,5.0,.1],carWidth:[1.20,2.40,.05],carDepth:[1.20,2.40,.05],carHeight:[2.10,2.80,.05],
      doorWidth:[.70,1.40,.05],doorHeight:[1.90,2.40,.05],windowWidth:[.12,.50,.02],windowHeight:[.40,1.30,.05],windowTopMargin:[.08,.40,.02],
